...
def main():
    ...
    test_file_dir ='/root/autodl-tmp/multi_nanoGCG/datset/'
    test_file     = test_file_dir+ling_list[dest]+'_harmful_behaviors.csv'
    
    out_file_dir  ='/root/autodl-tmp/multi_nanoGCG/result/'
    ...
    columns     = ['goal','target','ml_goal','ml_target','en_suffix','ml_suffix','loss','ml_loss']
